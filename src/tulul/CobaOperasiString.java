...
public class CobaOperasiString {
    public static void main(String[] args)
    {
        ...
        String identitas ="Adhy Pramudhia / XRPL3 / 01";
        ...
        System.out.println("isi x sama dengan r (Case Sensitive} : " + x.equals(z));
...
//        
        ...
        System.out.println("gabungkan isi veriable x dan r : " +x.concat(r));
//        
